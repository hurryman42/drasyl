...
LOW_WATERMARK = 3 -- minimum number of devices the primary controller should have after offloading (just_starting prevents chaos at the beginning); at LOW_WATERMARK-1 --> decommission a sub-controller
